...
- Ajouter le code nécessaire à l'affichage de ces bâtiments dans la méthode `Render`. Une pizzeria est un carré plein de 50 pixels de côté et de couleur grise. Attention : la position indique le centre du carré et on veut que les pizzerias soient entièrement visibles.
