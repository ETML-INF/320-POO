...
- Dans la méthode `Drone.Update`, on va parcourir la liste des pizzerias. Pour chacune d'elles, on regarde si il a des commandes. Dès qu'une commande a été trouvée, on l'enregistre dans notre objet drone et on annonce dans la console la prise de la commande.
